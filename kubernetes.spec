...
Source0  : https://github.com/kubernetes/kubernetes/archive/v1.7.6.tar.gz
...
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause CC-BY-SA-4.0 CC0-1.0 CDDL-1.0 GPL-2.0 ISC LGPL-3.0 MIT MPL-2.0-no-copyleft-exception NCSA
...
export LANG=C
export SOURCE_DATE_EPOCH=1505396222
